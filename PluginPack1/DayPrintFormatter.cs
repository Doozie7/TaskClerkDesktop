...
namespace BritishMicro.TaskClerk
{
    ...
    /// </summary>
    [Description("Produces a single page report containing a graph and the recorded entries for a day.")]
    [DisplayName("Day Report")]
    [TaskClerkPluginAttribute]
    class DayPrintFormatter : PluginPrintFormatter
    {
