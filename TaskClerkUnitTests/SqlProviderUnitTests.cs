    ...
    public class SqlProviderUnitTests
    {
        ...
        public void SaveActivities()
        {
            ...
            for (int n = 0; n < 10; n++)
            {
                ...
                {
                    StartDate = DateTime.Now.AddMinutes(-(n * rnd.Next(20))),
                    EndDate = DateTime.Now.AddMinutes(n * rnd.Next(20)),
                    Remarks = "Windows 98, Windows Server 2000 SP4, Windows CE, Windows Millennium Edition, Windows Mobile for Pocket PC, Windows Mobile for Smartphone, Windows Server 2003, Windows XP Media Center Edition, Windows XP Professional x64 Edition, Windows XP SP2, Windows XP Starter Edition".Substring(0, rnd.Next(50)),
                    CrosstabTaskDescription = TaskDescription.Empty
                };
                activities.Add(ta);
            }
